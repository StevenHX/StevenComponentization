package com.hx.steven.component.swipeback;
...
/**
 * Created by huangxiao on 2018/3/27.
 */
...
public class SlidingLayout extends FrameLayout {
    ...
    private void initView(Context context) {
        ...
        int density = (int) getResources().getDisplayMetrics().density; mShadowWidth = SHADOW_WIDTH * density;
    }
